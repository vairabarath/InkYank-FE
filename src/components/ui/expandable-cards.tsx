                ...
                <div className="flex justify-between items-start p-4">
                  <div className="">
                    <motion.h3
                      ...
                      className="font-medium text-neutral-700 00 text-base"
                    >
                      {active.title}
                    </motion.h3>
                    <motion.p
                  ...
                  <motion.a
                    ...
                    href={active.link}
                    target="_blank"
                    className="px-4 py-3 text-sm rounded-full font-bold bg-blue text-white"
                  >
                    Visit
                  </motion.a>
                </div>
      ...
      <ul className="max-w-2xl mx-auto w-full grid grid-cols-1 md:grid-cols-2 items-start gap-4">
        {cards.map((card) => (
          <motion.div
            ...
            className="p-4 flex flex-col hover:bg-neutral-50 al-800 rounded-xl cursor-pointer"
          >
